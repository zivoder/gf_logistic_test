...
namespace Illuminate\Support\Facades {
     ...
     */        class Route {
         ...
         * @param \App\Enums\VersionEnum $from
         * @param \App\Enums\VersionEnum $to
         * @param mixed $param
         * @static 
         */        public static function versionRange($from, $to, $param = null)
        {
                        return \Illuminate\Routing\Router::versionRange($from, $to, $param);
        }
                    /**
         * 
         *
         ...
         * @param mixed $param
         * @static 
         */        public static function versionFrom($from, $param = null)
        {
                        return \Illuminate\Routing\Router::versionFrom($from, $param);
        }
                    /**
         * 
         *
         ...
         * @param mixed $param
         * @static 
         */        public static function versionTo($to, $param = null)
        {
                        return \Illuminate\Routing\Router::versionTo($to, $param);
        }
                    /**
         * 
         *
         * @see \App\Providers\AppServiceProvider::boot()
         * @param \App\Enums\VersionEnum $version
         * @static 
         */        public static function version($version)
        {
                        return \Illuminate\Routing\Router::version($version);
        }
            }
            /**
     * 
...
namespace Illuminate\Routing {
     ...
     */        class Route {
         ...
         */        public static function versionRange($from, $to, $param = null)
        {
                        return \Illuminate\Routing\Route::versionRange($from, $to, $param);
        }
                    /**
         * 
         *
         ...
         */        public static function versionFrom($from, $param = null)
        {
                        return \Illuminate\Routing\Route::versionFrom($from, $param);
        }
                    /**
         * 
         *
         ...
         */        public static function versionTo($to, $param = null)
        {
                        return \Illuminate\Routing\Route::versionTo($to, $param);
        }
            }
    }
